...
export default function CheckoutPage() {
  ...
  // After component mounts, cart data from localStorage is available
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // 2. Initiate online payment (SSLCommerz)
          ...
          <section className="rounded-lg border border-outline-variant p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <input
                ...
                placeholder="Email"
                required
                className="w-full rounded border border-outline-variant px-3 py-2 sm:col-span-2"
              />
              <input
                name="addressLine1"
