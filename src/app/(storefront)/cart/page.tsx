        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              <div
                key={item.variantId}
                className="flex gap-4 rounded-lg border border-outline-variant p-4"
              >
          ...
          <div className="rounded-lg border border-outline-variant p-6 h-fit">
            ...
            {/* ✅ Wrap in Link so clicking navigates to checkout */}
            <Link
              href="/checkout"
              className="mt-4 block w-full rounded-lg bg-primary py-2 text-center text-on-primary hover:bg-primary-container"
            >
              Proceed to Checkout
            </Link>
          </div>
